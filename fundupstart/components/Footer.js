    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a href="/signup" className="text-gray-600 hover:text-gray-800">Sign up</a>
          </li> 
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Join a syndicate</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Create a syndicate</a>
          </li>
